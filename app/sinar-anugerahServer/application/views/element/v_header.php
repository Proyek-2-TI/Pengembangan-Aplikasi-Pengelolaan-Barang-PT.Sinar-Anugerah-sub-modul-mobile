                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li>
                         ...
                         <li>
                            <a href="<?php echo site_url('master/supplier_data')?>"><i class="fa fa-group fa-fw"></i> Data Supplier</a>
                        </li>
                         <li>
                            <a href="<?php echo site_url('master/barang_data')?>"><i class="fa fa-desktop fa-fw"></i> Data Barang</a>                            
                        </li>
                         <li>
                            <a href="<?php echo site_url('master/pelanggan_data')?>"><i class="fa fa-money fa-fw"></i> Data Customer</a>
                        </li>
                         <li>
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li>
                         ...
                         <li>
                            <a href="<?php echo site_url('pemesanan')?>"><i class="fa fa-truck fa-fw"></i> Pemesanan Barang</a>
                        </li>
                         <li>
                            <a href="<?php echo site_url('barang_masuk')?>"><i class="fa fa-bank fa-fw"></i> Barang Masuk</a>
                        </li>
...
<section style="text-align:center">
        <button onclick="playPause()" type="button" class="btn btn-danger btn-circle btn-xl"><i class="fa fa-heart"></i></button>
        <br />
        <video id="test" width=840 onclick="myVideo.play()">
                  <source src="http://localhost/sinar-anugerahBeta/asset/1234.mp4" type="video/mp4">
        </video>
    </section>
