                ...
                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-outline btn-primary" href="<?php echo site_url('barang_masuk/detail_barang_supplier/'.$row->kd_supplier)?>">
                                    <i class="fa fa-eye fa-fw"></i> View Barang
                                </a>                            
                                <a type="button" class="btn btn-outline btn-info" href="<?php echo site_url('barang_masuk/pages_tambah_barang_masuk/'.$row->kd_supplier);?>"> 
